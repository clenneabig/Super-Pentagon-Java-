...
public void drawHighScoresEasy() {
  textFont(font);
  textSize(30);
  fill(255);
...
public void drawHighScoresHard() {
  textFont(font);
  textSize(30);
  fill(255);
  text(highScores, width/2-textWidth(highScores)/2, height/8);
...
enum State {
  IN_GAME1, IN_GAME2, MENU, GAME_OVER, GOAL, CONTROLS, SCORES1, SCORES2
}
